  ...
  tar_target(
    all_means,
    {
      ...
      summary_means <- tibble::tibble(
        ...
        t_sf_up = t_sf_summary$mean,
        t_sf_sigma_up = t_sf_summary$sd,
        tau_up = tau_summary$mean,
        tau_sigma_up = tau_summary$sd,
        A_up = A_summary$mean,
        A_sigma_up = A_summary$sd,
        x_up = x_summary$mean,
        x_sigma_up = x_summary$sd
      )
