...
To begin with the morphological types of the galaxies we first need to understand possible incompatabilities of the given types of each catalog.
...
Scatter plots and the residuals of the Hubble Numerical morphological types
:::
