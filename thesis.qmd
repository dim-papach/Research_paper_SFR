...
the root $x_0\Leftrightarrow g(x_0) = 0$, can be found, for each galaxy. From @eq-A we can calculate the normilization constant of the galaxies, as well as their charachteristic timescales $\tau = t_{sf}\cdot x$.
