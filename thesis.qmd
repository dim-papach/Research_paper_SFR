...
Before we merge the two catalogs we need to compare the corresponding quantities to ensure that there are no major incompatabilities. The quantities that are comparable are:

-   Distances \[Mpc\]
-   Radial Velocities \[km/s\]
-   Morphology and Geometry of the galaxies
    -   Morphological type (Numerical Hubble)
    -   Inclination \[degrees\]
    -   Angular Diameter of the Major and Semi-major axis \[arcmin\]
-   K-band Luminosity \[$L_\odot$\]
-   K and B-band Magnitudes \[mag\]
-   Star Formation Rates \[$M_\odot/yr$\]
