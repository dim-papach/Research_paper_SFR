...
Let $x^{(i)}$ be a homoguneous Markov chain[^5] inside a high-dimensional space $X$ of the set of possible configurations of a system and the space on which the posterior is defined, $x^{(i)}\in X = {x_1,x_2,...}$.
