...
topcat -stilts plot2plane \
   ...
   in=/home/dp/Documents/Research_paper_SFR/r_mcmc_uni/joined_data.csv ifmt=CSV x=logM_total y=A \
...
topcat -stilts plot2plane \
   ...
   auxvisible=true auxlabel='x=t_{sf}/\tau' \
   legend=true legpos=0.0103,0.944 \
   in=/home/dp/Documents/Research_paper_SFR/r_mcmc_normal/joined_data.csv ifmt=CSV x=logM_total y=A \
