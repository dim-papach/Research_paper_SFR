...
plt.show()
```
Here we can see an attempt to correlate the internal absorption of the two catalogs, however as it is very clear, there is no correlation, since even their distributions are not similar.
:::
