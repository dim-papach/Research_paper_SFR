...
def scatter_plot(x, y, xerr = None, yerr = None, sigma = False):
    ...
    if outliers is not None:
        filtered_data = np.ma.masked_array(y_data, mask = outliers)
        plt.errorbar(x_data, y_data, yerr=yerr_d, c = "black", label="Clipped Data", fmt = "o", fillstyle = "none")
        plt.scatter(x_data, filtered_data,  label="Fitted Data", c = "blue")
    else:
