...
\caption{\label{tbl-dis-comp}Table showing the Completeness of the
Catalogs, per bin}

\begin{minipage}{0.50\linewidth}

\subcaption{\label{tbl-dis-comp-1}HECATE}

\centering{

\begin{tabular}{rrll}
\toprule
Bin Start & Bin End & Unique \% & Inner \%\\
\midrule
0 & 0 & 43\% & 57\%\\
0 & 1 & 93\% & 7\%\\
1 & 1 & 95\% & 5\%\\
...
\subcaption{\label{tbl-dis-comp-2}LCV}
